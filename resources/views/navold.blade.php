        ...
        <div class="bg-indigo-50 p-10 rounded-lg">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    ...
                    <p class="text-gray-700 mb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam,
                        eveniet impedit modi harum quae quia voluptates veniam odio expedita, commodi nesciunt et
                        deleniti sunt voluptate cumque explicabo iure molestiae eum.</p>
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    <h3 class="text-2xl font-bold mb-4">Mantap</h3>
                    <p class="text-gray-700 mb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque nam
                        dolorem, laboru, sint, asperiores et hic mollitia sequi voluptates suscipit nobis eveniet aut
                        doloribus iusto qui minima animi earum aliquid?</p>
                    <div class="flex items-center">
                        <img class="w-16 h-16 rounded-full mr-6" src="https://via.placeholder.com/64" alt="Avatar">
                        <div>
                            <p class="font-bold text-lg">Ganjar</p>
        ...
        <div class="bg-blue-50 p-10 rounded-xl shadow-lg w-[960px]">
            ...
            <form id="contactForm" class="space-y-4">
                <div>
                    ...
                    <input type="text" id="name" name="name" class="w-full p-2 rounded bg-gray-200"
                        required>
                </div>
                <div>
                    <label for="email" class="block font-semibold">E-mail</label>
                    <input type="email" id="email" name="email" class="w-full p-2 rounded bg-gray-200"
                        required>
                </div>
                <div>
                    <label for="phone" class="block font-semibold">Nomor Hp</label>
                    <input type="tel" id="phone" name="phone" class="w-full p-2 rounded bg-gray-200"
                        required>
                </div>
                <div>
                    <label for="message" class="block font-semibold">Pesan</label>
                    <textarea id="message" name="message" rows="4" maxlenght="50" class="w-full p-2 rounded bg-gray-200"
                        required></textarea>
                </div>
                <button type="submit" id="submitBtn"
                    class="w-full p-2 bg-orange-400 text-white rounded hidden">Kirim</button>

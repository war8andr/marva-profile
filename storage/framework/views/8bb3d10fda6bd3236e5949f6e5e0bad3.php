...
<div class="flex flex-col items-center justify-center min-h-screen bg-white">
    <div class="flex items-center justify-between w-full max-w-5xl p-8">
        ...
        <div>
            <img src="../source/abot.png" alt="Company Image" class="w-96 h-auto hidden sm:block">
        </div>
    </div>
</div>
<div class="max-w-[950px] mx-auto min-w-[200px] px-4">
    <h2 class="text-4xl font-bold mb-8 text-center md:text-left">Testimoni</h2>
    <div class="bg-indigo-50 p-10 rounded-lg">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <h3 class="text-2xl font-bold mb-4">Mantap</h3>
                <p class="text-gray-700 mb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Totam, eveniet impedit modi harum quae quia voluptates veniam odio expedita, commodi nesciunt et deleniti sunt voluptate cumque explicabo iure molestiae eum.</p>
                <div class="flex items-center">
                    <img class="w-16 h-16 rounded-full mr-6" src="https://via.placeholder.com/64" alt="Avatar">
                    <div>
                        <p class="font-bold text-lg">Ganjar</p>
                        <p class="text-gray-600 text-md">Customer</p>
                    </div>
                </div>
            </div>
            <div class="bg-white p-8 rounded-lg shadow-lg">
                <h3 class="text-2xl font-bold mb-4">Mantap</h3>
                <p class="text-gray-700 mb-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque nam dolorem, laboru, sint, asperiores et hic mollitia sequi voluptates suscipit nobis eveniet aut doloribus iusto qui minima animi earum aliquid?</p>
                <div class="flex items-center">
                    <img class="w-16 h-16 rounded-full mr-6" src="https://via.placeholder.com/64" alt="Avatar">
                    <div>
                        <p class="font-bold text-lg">Ganjar</p>
...
<div class="bg-blue-50 p-10 rounded-xl shadow-lg w-[960px]">

        <h2 class="text-center text-2xl mb-5">Tulis Pesan Anda Disini</h2>
        <form action="<?php echo e(route('send.email')); ?>" method="POST" class="space-y-4" id="contact">
            <?php echo csrf_field(); ?>
            <div>
                <label class="block font-semibold">Name</label>
                <input id="name" name="name" type="text" class="w-full p-2 rounded bg-gray-200 form-control" required>
            </div>
            <div>
                <label class="block font-semibold">E-mail</label>
                <input id="email" name="email" type="email" class="w-full p-2 rounded bg-gray-200 form-control" required>
            </div>
            <div>
                <label class="block font-semibold">Message</label>
                <textarea id="message" name="message" rows="4" maxlenght="50" class="w-full p-2 rounded bg-gray-200 form-control" required></textarea>
            </div>
            <button type="submit" name="send" id="contact-submit" class="w-full p-2 bg-orange-400 text-white rounded hidden">Kirim</button>
            <p class="text-xs text-gray-600 text-center mt-2">*Tombol hanya akan muncul jika semua field terisi</p>
